...
/***/ "./src/app/modules/login/components/login-adm/login-adm.component.css":
/*!****************************************************************************!*\
  !*** ./src/app/modules/login/components/login-adm/login-adm.component.css ***!
  \****************************************************************************/
...
module.exports = ".login-container {\r\n  height: 100%;\r\n  width: 100%;\r\n  background: url('imgLogin.jpg') no-repeat center;\r\n}\r\n\r\n.mat-card {\r\n  border-radius: 10px;\r\n}\r\n\r\n#btn-acessar {\r\n  margin-bottom: 8px !important;\r\n}\r\n\r\n.login-card-actions {\r\ndisplay: inherit;\r\n}\r\n"

/***/ }),

/***/ "./src/app/modules/login/components/login-adm/login-adm.component.html":
/*!*****************************************************************************!*\
  !*** ./src/app/modules/login/components/login-adm/login-adm.component.html ***!
  \*****************************************************************************/
/*! no static exports found */
...
module.exports = "<div fxLayout=\"row\" fxLayoutAlign=\"center center\" class=\"login-container\">\r\n\r\n  <form [formGroup]=\"form\">\r\n    <mat-card class=\"login-card\">\r\n      <mat-card-title>Acessar</mat-card-title>\r\n      <mat-card-subtitle>Preencha os campos</mat-card-subtitle>\r\n      <mat-card-content>\r\n        <div fxLayout=\"col wrap\">\r\n          <mat-form-field hintLabel=\"Max 11 characters\" fxFlex=\"100%\">\r\n            <mat-label>CPF</mat-label>\r\n            <input matInput type='text' minlength=\"11\" matTooltip=\"CPF - Deve conter 11 characters\" matTooltipPosition=\"above\" mask=\"000.000.000-00\" formControlName=\"cpf\" required>\r\n          </mat-form-field>\r\n          <mat-form-field fxFlex=\"100%\">\r\n            <mat-label>Senha</mat-label>\r\n            <input matInput type=\"password\" minlength=\"6\" matTooltip=\"Senha - De 6 a 8 characters\" matTooltipPosition=\"above\" formControlName=\"senha\" required>\r\n          </mat-form-field>\r\n        </div>\r\n      </mat-card-content>\r\n      <div fxLayout=\"col wrap\" fxLayoutAlign=\"center end\" class=\"login-card-actions\">\r\n        <button mat-flat-button fxFlex=\"100%\" id=\"btn-acessar\" (click)=\"acessar()\" [disabled]=\"form.invalid\">Acessar</button>\r\n        <!-- <button mat-flat-button fxFlex=\"100%\" id=\"btn-acessar\" routerLink=\"/app\" [disabled]=\"form.invalid\">Acessar</button>\r\n        <button mat-flat-button fxFlex=\"100%\" id=\"btn-signup\" routerLink=\"/signup\" [disabled]=\"form.invalid\">Registrar</button> -->\r\n      </div>\r\n    </mat-card>\r\n  </form>\r\n\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/modules/login/components/login-adm/login-adm.component.ts":
/*!***************************************************************************!*\
  !*** ./src/app/modules/login/components/login-adm/login-adm.component.ts ***!
  \***************************************************************************/
/*! exports provided: LoginAdmComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoginAdmComponent", function() { return LoginAdmComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _services_requests_feedback_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../services/requests-feedback.service */ "./src/app/services/requests-feedback.service.ts");
...
var LoginAdmComponent = /** @class */ (function () {
    function LoginAdmComponent(formBuilder, router, authService, tokenService, loader, reqFeedback, usuarioService) {
    ...
    LoginAdmComponent.prototype.ngOnInit = function () { };
    LoginAdmComponent.prototype.onLoggedin = function () {
        localStorage.setItem('isLoggedin', 'true');
    };
    LoginAdmComponent.prototype.acessar = function () {
        var _this = this;
        this.loader.show();
        var _a = this.form.value, cpf = _a.cpf, senha = _a.senha;
        this.authService.getAutenticar(cpf, senha)
            .subscribe(function (token) {
            _this.tokenService.gravarToken(token);
            _this.usuarioService.salvarCodigoUsuario(token.OwnerCod);
            _this.router.navigate(['/app/cadastro/relacao-cadastros']);
            _this.loader.hide();
        }, function (error) {
            _this.reqFeedback.addFeedback(error, null, false);
            _this.loader.hide();
        });
    };
    LoginAdmComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-login-adm',
            template: __webpack_require__(/*! ./login-adm.component.html */ "./src/app/modules/login/components/login-adm/login-adm.component.html"),
            styles: [__webpack_require__(/*! ./login-adm.component.css */ "./src/app/modules/login/components/login-adm/login-adm.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            ...
            _services_requests_feedback_service__WEBPACK_IMPORTED_MODULE_6__["RequestsFeedbackService"],
            _services_usuario_service__WEBPACK_IMPORTED_MODULE_7__["UsuarioService"]])
    ], LoginAdmComponent);
    return LoginAdmComponent;
}());
...
/***/ "./src/app/modules/login/components/login-layout/login-layout.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/modules/login/components/login-layout/login-layout.component.ts ***!
  \*********************************************************************************/
...
module.exports = ".login-container {\r\n    height: 100%;\r\n    width: 100%;\r\n    background: url('imgLogin.jpg') no-repeat center;\r\n}\r\n\r\n#btn-acessar {\r\n    margin-bottom: 8px !important;\r\n}\r\n\r\n.login-card-actions {\r\n  display: inherit;\r\n}\r\n\r\n.login-block{\r\n  background: #4b6cb7;  /* fallback for old browsers */  /* Chrome 10-25, Safari 5.1-6 */\r\nbackground: linear-gradient(to bottom, #4b6cb7, #182848); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\r\nfloat:left;\r\nwidth:100%;\r\npadding : 50px 0;\r\n}\r\n\r\n.banner-sec{background:url('https://static.pexels.com/photos/33972/pexels-photo.jpg')  no-repeat left bottom; background-size:cover; min-height:500px; border-radius: 0 10px 10px 0; padding:0;}\r\n\r\n.container{background:#fff; border-radius: 10px; box-shadow:15px 20px 0px rgba(0,0,0,0.1);}\r\n\r\n.login-sec{padding: 150px 30px; position:relative;}\r\n\r\n.login-sec .copy-text{position:absolute; width:80%; bottom:20px; font-size:10px; text-align:center;}\r\n\r\n.login-sec .copy-text i{color:#274072;}\r\n\r\n.login-sec .copy-text a{color:#4b6cb7;}\r\n\r\n.login-sec h2{margin-bottom:30px; font-weight:800; font-size:30px; color: #274072;}\r\n\r\n.login-sec h2:after{content:\" \"; width:100px; height:5px; background:#4b6cb7; display:block; margin-top:20px; border-radius:3px; margin-left:auto;margin-right:auto}\r\n\r\n.btn-login{background: #274072; color:#fff; font-weight:600;}\r\n\r\n.banner-text{width:70%; position:absolute; bottom:40px; padding-left:20px;}\r\n\r\n.banner-text h2{color:#fff; font-weight:600;}\r\n\r\n.banner-text h2:after{content:\" \"; width:100px; height:5px; background:#FFF; display:block; margin-top:20px; border-radius:3px;}\r\n\r\n.banner-text p{color:#fff;}\r\n"
...
module.exports = "<section class=\"login-block\">\r\n  <div class=\"container\">\r\n    <div class=\"row\">\r\n      <div class=\"col-sm-8 banner-sec\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-4 login-sec\">\r\n          <h2 class=\"text-center\">BELOTUR</h2>\r\n          <!-- <form class=\"login-form\"> -->\r\n          <div class=\"form-group\">\r\n              <button mat-flat-button type=\"button\" class=\"btn-lg btn-block\" routerLink=\"/formulario\">Ambulante (Quero me cadastrar)</button>\r\n              <!-- <button type=\"button\" class=\"btn btn-outline-secondary btn-lg btn-block\" (click)=\"abrirArmazenarContato()\">Ambulante (Quero me cadastrar)</button> -->\r\n          </div>\r\n          <br>\r\n          <div class=\"form-group\">\r\n              <button mat-flat-button type=\"button\" class=\"btn-lg btn-block\" routerLink=\"/login/auth\">Atendente (Area Restrita)</button>\r\n          </div>\r\n\r\n\r\n          <div class=\"form-check\">\r\n            <label class=\"form-check-label\">\r\n\r\n            </label>\r\n          </div>\r\n          <!-- </form> -->\r\n\r\n        </div>\r\n\r\n    </div>\r\n    <!-- </section> -->\r\n"
...
/* harmony import */ var _services_requests_feedback_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../services/requests-feedback.service */ "./src/app/services/requests-feedback.service.ts");
...
/* harmony import */ var _cadastro_component_formulario_formulario_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../cadastro/component/formulario/formulario.component */ "./src/app/modules/cadastro/component/formulario/formulario.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, router, authService, tokenService, loader, reqFeedback, usuarioService, dialog) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.authService = authService;
        this.tokenService = tokenService;
    ...
    LoginComponent.prototype.acessar = function () {
        var _this = this;
        this.loader.show();
        var _a = this.form.value, usuario = _a.usuario, senha = _a.senha;
    ...
    LoginComponent.prototype.abrirArmazenarContato = function (model) {
        this.dialog.open(_cadastro_component_formulario_formulario_component__WEBPACK_IMPORTED_MODULE_9__["FormularioComponent"], {
            data: {
                dados: model
            },
            // minWidth: '100%',
    ...
    LoginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./login.component.css */ "./src/app/modules/login/components/login/login.component.css")],
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            ...
            _services_requests_feedback_service__WEBPACK_IMPORTED_MODULE_7__["RequestsFeedbackService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _components_login_layout_login_layout_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/login-layout/login-layout.component */ "./src/app/modules/login/components/login-layout/login-layout.component.ts");
/* harmony import */ var _components_login_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/login/login.component */ "./src/app/modules/login/components/login/login.component.ts");
/* harmony import */ var _components_login_adm_login_adm_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/login-adm/login-adm.component */ "./src/app/modules/login/components/login-adm/login-adm.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '', component: _components_login_layout_login_layout_component__WEBPACK_IMPORTED_MODULE_2__["LoginLayoutComponent"], children: [
            { path: '', component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] },
            { path: 'auth', component: _components_login_adm_login_adm_component__WEBPACK_IMPORTED_MODULE_4__["LoginAdmComponent"] }
        ]
    }
];
...
/* harmony import */ var _components_login_layout_login_layout_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/login-layout/login-layout.component */ "./src/app/modules/login/components/login-layout/login-layout.component.ts");
/* harmony import */ var _components_login_login_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/login/login.component */ "./src/app/modules/login/components/login/login.component.ts");
/* harmony import */ var _login_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./login-routing.module */ "./src/app/modules/login/login-routing.module.ts");
/* harmony import */ var _shared_material_components_material_components_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../shared/material-components/material-components.module */ "./src/app/shared/material-components/material-components.module.ts");
/* harmony import */ var _components_login_adm_login_adm_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/login-adm/login-adm.component */ "./src/app/modules/login/components/login-adm/login-adm.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    LoginModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _shared_material_components_material_components_module__WEBPACK_IMPORTED_MODULE_9__["MaterialComponentsModule"],
                _angular_flex_layout__WEBPACK_IMPORTED_MODULE_2__["FlexLayoutModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
                ngx_mask__WEBPACK_IMPORTED_MODULE_5__["NgxMaskModule"].forRoot()
            ],
            declarations: [
                _components_login_layout_login_layout_component__WEBPACK_IMPORTED_MODULE_6__["LoginLayoutComponent"],
                _components_login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"],
                _components_login_adm_login_adm_component__WEBPACK_IMPORTED_MODULE_10__["LoginAdmComponent"],
            ],
            providers: [
...
/***/ "./src/app/services/requests-feedback.service.ts":
/*!*******************************************************!*\
  !*** ./src/app/services/requests-feedback.service.ts ***!
  \*******************************************************/
/*! exports provided: RequestsFeedbackService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RequestsFeedbackService", function() { return RequestsFeedbackService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var RequestsFeedbackService = /** @class */ (function () {
    function RequestsFeedbackService() {
        this.feedback = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](null);
    }
    Object.defineProperty(RequestsFeedbackService.prototype, "newFeedback", {
        get: function () {
    ...
    RequestsFeedbackService.prototype.addFeedback = function (msg, action, success) {
        var panelClass = '';
    ...
    RequestsFeedbackService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [])
    ], RequestsFeedbackService);
    return RequestsFeedbackService;
}());
